...
namespace App\Tarot\Application\CorrectLastClassicDeal;
...
final readonly class CorrectLastClassicDealCommandHandler
{
    public function __construct(
        private GameRepository $gameRepository,
    ) {}

    public function handle(CorrectLastClassicDealCommand $command): void
    {
